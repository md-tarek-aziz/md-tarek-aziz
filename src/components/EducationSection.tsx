  ...
  return (
    <section id="education" className="py-20 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col items-center mb-12 text-center">
        ...
        >
          <GraduationCap size={16} className="text-[#d4f826]" />
          <span>
        ...
        >
          {lang === 'bn' ? (
            <>
              আমার শিক্ষা ও <span className="text-[#d4f826]">সৃজনশীল দক্ষতা</span>
            </>
          ) : (
            <>
              My Education & <span className="text-[#d4f826]">Creative Learning</span>
            </>
          )}
        </motion.h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {defaultAcademic.map((item, idx) => (
          <motion.div
            ...
            className="group border border-[#d4f826]/30 rounded-3xl p-6 bg-[#0a0a0a]/70 backdrop-blur shadow-[0_0_15px_rgba(212,248,38,0.1)] hover:border-[#d4f826] hover:shadow-[0_0_25px_rgba(212,248,38,0.35)] transition-all duration-300 flex flex-col"
          >
            ...
            <div className="flex justify-between items-start mb-4">
              <motion.div
                ...
                className="text-[#d4f826] p-2.5 rounded-xl border border-[#d4f826]/30 bg-[#1a1a1a]/50 shadow-[0_0_10px_rgba(212,248,38,0.2)]"
              >
                <BookOpen size={20} />
              </motion.div>
            ...
            {/* Title & Subtitle */}
            <h4 className="font-bold text-lg text-white mb-1 group-hover:text-[#d4f826] transition-colors">
              {item.title}
            </h4>
            <p className="text-sm text-[#d4f826] mb-3 font-bold">
              {item.desc}
            </p>
            ...
            <div className="border-t border-[#262626] pt-4 mt-auto">
              <div className="flex justify-between items-center text-xs font-bold">
                ...
                <span className="text-[#d4f826] group-hover:drop-shadow-[0_0_8px_rgba(212,248,38,0.8)] transition-all duration-300">
                  {item.status}
                </span>
              </div>
            </div>
      ...
      <motion.div
        whileHover={{ borderColor: '#d4f826' }}
        className="border border-[#d4f826]/30 rounded-3xl sm:rounded-[32px] p-6 sm:p-8 md:p-10 bg-[#0a0a0a]/80 backdrop-blur transition-all duration-300 hover:border-[#d4f826] hover:shadow-[0_0_30px_rgba(212,248,38,0.2)]"
      >
        {/* Top Header Row */}
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-[#141414] border border-[#d4f826]/30 flex items-center justify-center text-[#d4f826] shadow-[0_0_10px_rgba(212,248,38,0.2)]">
          ...
          <span className="px-3.5 py-1 rounded-full border border-[#d4f826]/40 bg-[#141414] text-xs font-bold text-[#d4f826] shadow-[0_0_10px_rgba(212,248,38,0.2)]">
        ...
        <div className="flex flex-wrap gap-2.5 mb-8">
          {defaultTraining.badges.map((badge) => (
            <span
              key={badge}
              className="px-3.5 py-1.5 bg-[#141414] border border-[#262626] text-[#d4f826] text-xs rounded-full font-bold"
            >
              {badge}
            </span>
          ))}
        ...
        <h5 className="font-bold text-sm sm:text-base mb-4 flex items-center gap-2 text-white tracking-wide">
          <CheckCircle size={18} className="text-[#d4f826]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          {defaultTraining.competencies.map((comp) => (
            <div
              key={comp.title}
              className="p-4 sm:p-5 bg-[#121212] rounded-2xl border border-[#222222] hover:border-[#d4f826]/40 transition-colors"
            >
              <h6 className="text-sm font-bold text-white mb-1 flex items-center gap-2">
                <CheckCircle size={16} className="text-[#d4f826] shrink-0" />
        ...
        <div className="border-t border-[#1f1f1f] pt-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2.5 text-white font-bold text-sm sm:text-base">
            <Zap size={20} className="text-[#d4f826]" />
            <span>
              {lang === 'bn' ? 'বাস্তব প্রজেক্টের হ্যান্ডস-অন অভিজ্ঞতা' : 'Hands-on Real Project Execution'}
            </span>
          </div>

          <span className="px-5 py-2 rounded-full border border-[#d4f826] bg-[#141414] text-xs font-extrabold text-[#d4f826] shadow-[0_0_15px_rgba(212,248,38,0.35)] select-none">
