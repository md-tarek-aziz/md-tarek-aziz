      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-[#0a0a0a] border border-[#262626] rounded-2xl shadow-2xl flex flex-col">
        ...
        <div className="sticky top-0 z-10 px-6 py-4 bg-[#0a0a0a]/95 backdrop-blur-md border-b border-[#262626] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-[#d4f826]/10 border border-[#d4f826]/30 flex items-center justify-center text-[#d4f826]">
              <Edit3 size={16} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleSave}
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#d4f826] hover:bg-[#c2e223] text-black font-extrabold text-xs transition-colors cursor-pointer"
            >
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="p-4 rounded-xl bg-[#141414] border border-[#262626] space-y-3">
            <span className="text-xs font-mono text-[#d4f826] uppercase tracking-wider block font-bold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-[#0a0a0a] border border-[#262626] text-sm text-white font-bold uppercase focus:outline-none focus:border-[#d4f826]"
                />
              </div>

              <div>
                <label className="text-xs font-mono text-neutral-400 block mb-1">
                  Line 2 (Neon Yellow Headline)
                </label>
                <input
                  type="text"
                  ...
                  placeholder="AZIZ"
                  className="w-full px-3 py-2 rounded-lg bg-[#0a0a0a] border border-[#262626] text-sm text-[#d4f826] font-bold uppercase focus:outline-none focus:border-[#d4f826]"
                />
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-[#141414] border border-[#262626] flex flex-col sm:flex-row items-center gap-4">
            <div className="w-20 h-20 rounded-2xl bg-neutral-900 border border-[#d4f826]/40 overflow-hidden relative shrink-0">
              <img
            ...
            <div className="flex-1 w-full space-y-2">
              ...
              <input
                ...
                className="block w-full text-xs text-neutral-400 file:mr-3 file:py-1.5 file:px-3.5 file:rounded-full file:border-0 file:text-xs file:font-bold file:bg-[#d4f826] file:text-black hover:file:bg-[#c2e223] cursor-pointer"
              />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-[#141414] border border-[#262626] text-sm text-white focus:outline-none focus:border-[#d4f826]"
              />
            </div>
          ...
          <div className="pt-4 border-t border-[#262626] flex justify-between items-center">
            ...
            <button
              onClick={handleSave}
              className="px-5 py-2 rounded-full bg-[#d4f826] hover:bg-[#c2e223] text-black font-extrabold text-xs transition-colors cursor-pointer shadow-lg"
            >
